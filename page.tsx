      ...
      {!clerkEnabled && (
        <div className="bg-yellow-50 border-b border-yellow-200 px-4 py-3">
          <p className="text-center text-sm text-yellow-800">
            <strong>Demo Mode:</strong> Authentication is not configured. Set up Clerk to enable sign-in and full functionality.
          </p>
        </div>
      )}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {clerkEnabled ? (
              ...
              <Link href="/demo" className="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl flex items-center justify-center gap-2">
                Try Demo Analysis
                <ArrowRight className="w-5 h-5" />
              </Link>
            )}
      ...
      <section className="py-20 px-4 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {clerkEnabled ? (
            ...
            <Link href="/demo" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl hover:bg-blue-50">
              Try Demo Analysis
              <ArrowRight className="w-5 h-5" />
            </Link>
          )}
